...
const Util = {
  ...
  toKnexColumn (table, _name, attrDefinition, wlModel, schema) {
    ...
    if (attrDefinition.foreignKey && attrDefinition.model) {
      ...
      //const pkdef = refModel.definition[fpk]
    ...
    if (attrDefinition.foreignKey && attrDefinition.references && attrDefinition.on) {
      ...
      //console.log('here', attrDefinition)
      //console.log('there', schema[attrDefinition.references].attributes[attrDefinition.on])
      //console.log('setting foreign key type', type)
    }
